...
3. **Algorithm Transition**: While ML-DSA is quantum-resistant, consider hybrid certificates (classical + PQC) for maximum compatibility during the transition period.

4. **Certificate Lifetime**: Post-quantum certificates may have different lifetime considerations. RFC 9881 doesn't mandate specific lifetimes.
